...
export default function MoodPromptModal() {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex flex-col items-center p-4 sm:p-6 overflow-y-auto">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-transparent z-10 my-auto py-8"
          >
            <button
              onClick={handleClose}
